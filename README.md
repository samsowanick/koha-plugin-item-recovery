...
$(document).ready(function() {
    ...
    '<a class="circ-button" href="https://staff.bywatersolutions.com/cgi-bin/koha/plugins/run.pl?class=Koha%3A%3APlugin%3A%3AItemRecovery&method=tool">' +
...
$(document).ready(function() {
  if ($(".problem.ret_badbarcode:contains('No item with barcode:')")) {
    ...
    '<a class="btn btn-default approve" href="https://staff.bywatersolutions.com/cgi-bin/koha/plugins/run.pl?class=Koha%3A%3APlugin%3A%3AItemRecovery&method=tool">' +
